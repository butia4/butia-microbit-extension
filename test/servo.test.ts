...
// --- run delegation ---
servoRobot1.servoRun(Butia.J1, 0, 75);
assertTest(servo1.speed === 75, "servoRun delegates");

// --- stop delegation ---
servoRobot1.servoStop(Butia.J1, 0);
assertTest(servo1.stopped === true, "servoStop delegates");

// --- setPulse delegation ---
servoRobot1.servoSetPulse(Butia.J1, 0, 1500);
assertTest(servo1.pulse === 1500, "servoSetPulse delegates");

// --- setRange delegation ---
servoRobot1.servoSetRange(Butia.J1, 0, 10, 170);
assertTest(servo1.minAngle === 10 && servo1.maxAngle === 170, "servoSetRange delegates");

// --- setStopOnNeutral delegation ---
servoRobot1.servoSetStopOnNeutral(Butia.J1, 0, true);
assertTest(servo1.stopOnNeutral === true, "servoSetStopOnNeutral delegates");
