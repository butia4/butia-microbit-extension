...
export default class Physics {
    ...
    public on(
        _obj: PhysicsObject,
        _event: string,
        _handler: (contact: Planck.Contact) => void
    ): void {
        // TODO: Register the object for contact events, filter and dispatch
    }

    // TODO: Dispatch contact events to entities from here
    private onBeginContact = (_contact: Planck.Contact) => {}
    private onEndContact = (_contact: Planck.Contact) => {}
    private onRemoveBody = (_body: Planck.Body) => {}
}
        ...
        for (
            ...
            switch (type) {
                case "polygon": {
                    ...
                    this._debugRenderObj.addChild(graphics as Pixi.DisplayObject)
