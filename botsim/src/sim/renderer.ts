...
export default class Renderer {
    ...
    constructor(private sim: Simulation) {
        ...
        this.pixi.stage.addChild(this._debugLayer as Pixi.DisplayObject)
    }
    ...
    public add(renderObj: RenderObject) {
        this.pixi.stage?.addChild(renderObj.handle as Pixi.DisplayObject)
    }
    ...
    public remove(renderObj: RenderObject) {
        this.pixi.stage?.removeChild(renderObj.handle as Pixi.DisplayObject)
    }
}
...
function createColoredCircleGraphics(
    ...
    return g as Pixi.DisplayObject
}
