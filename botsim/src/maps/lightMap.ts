...
export const LIGHT_MAP: MapSpec = {
    ...
    entities: [
        // Light source — draggable, randomly colored, dynamic physics so it
        // can be pushed/dragged around the arena like the default map's
        // obstacle boxes.
        {
            ...
            shapes: [{
                ...
                brush: { ...defaultColorBrush(), fillColor: MICROBIT_COLORS.YELLOW, borderColor: "#444444", borderWidth: 0.25, visible: true, zIndex: 1 },
            }],
        },
    ],
}
