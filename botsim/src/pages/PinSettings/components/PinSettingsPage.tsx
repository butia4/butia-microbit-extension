...
export function PinSettings({ onClose }: PinSettingsProps) {
    ...
    return (
        <div className="butia-screen-transition relative h-full w-full overflow-hidden rounded-tl-[6%_7%] rounded-tr-[6%_7%] rounded-bl-[7%_6%] rounded-br-[7%_6%] bg-(--butia-green-25) shadow-[inset_0_0_0_3px_var(--butia-green-100),inset_0_2px_12px_rgba(0,0,0,0.15)] font-(--font-body) text-(--butia-ink-900)">
            <div
                ref={containerRef}
