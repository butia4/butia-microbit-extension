namespace Butia {
    class ButiaV4Builder implements IRobotRecord {
        model: RobotModel;
        ...
        constructor() {
            ...
            this.defaultConfig = {
                connectorPins: [
                    ...
                    { connector: Connector.Port5, pin: DigitalPin.P10 },
                    { connector: Connector.Port6, pin: DigitalPin.P13 },
                    { connector: Connector.Port7, pin: DigitalPin.P14 },
                    { connector: Connector.Port8, pin: DigitalPin.P15 },
                    { connector: Connector.Port9, pin: DigitalPin.P16 },
                ],
                motorLeftConnectors: [Connector.Port6, Connector.Port7],
                motorRightConnectors: [Connector.Port8, Connector.Port9],
            };
        }
    ...
    RobotSystem.register(new ButiaV4Builder());
}
