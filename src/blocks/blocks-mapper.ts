//% color="#3a86ff" icon="" block="Butia Mapper"
//% groups="['Motors', 'Sensors', 'Generic Sensors', 'Servos']"
namespace butiaMapper {

    /**
     * Selects which botsim map to run against. The robot itself starts
     * automatically the first time any other Butia Mapper block runs — no
     * separate "start" block is needed.
     */
    //% blockId="butia_mapper_select_map"
    //% block="Butia Mapper use map %map"
    //% weight=111
    export function selectMap(map: ButiaSimMap): void {
        butia.RobotDriver.start(butia.butiaMapper);
     ...
     */
    //% blockId="butia_mapper_imp_move_forward"
     ...
     */
    //% blockId="butia_mapper_imp_move_backward"
     ...
     */
    //% blockId="butia_mapper_imp_motor_tank"
     ...
     */
    //% blockId="butia_mapper_imp_stop_single"
     ...
     */
    //% blockId="butia_mapper_imp_read_gray"
     ...
     */
    //% blockId="butia_mapper_imp_read_light"
     ...
     */
    //% blockId="butia_mapper_imp_distance"
     ...
     */
    //% blockId="butia_mapper_imp_read_button"
    ...
    //% shim=ENUM_GET
    //% blockId=sensor_enum_shim_mapper
    //% blockHidden=true
    //% block="$arg"
    //% enumName="SensorNameMapper"
     ...
     */
    //% blockId="butia_mapper_imp_read_generic"
    //% block="$sensorName sensor on $connector"
    //% sensorName.shadow="sensor_enum_shim_mapper"
    //% weight=67
    //% group="Generic Sensors"
    ...
    //% shim=ENUM_GET
    //% blockId=servo_enum_shim_mapper
    //% blockHidden=true
    //% block="$arg"
    //% enumName="ServoNameMapper"
     ...
     */
    //% blockId="butia_mapper_servo_set_angle"
    //% block="servo $servoName on $connector set angle to $degrees °"
    //% servoName.shadow="servo_enum_shim_mapper"
     ...
     */
    //% blockId="butia_mapper_evt_distance"
     ...
     */
    //% blockId="butia_mapper_evt_light"
     ...
     */
    //% blockId="butia_mapper_evt_sensor_range"
     ...
     */
    //% blockId="butia_mapper_evt_button"
